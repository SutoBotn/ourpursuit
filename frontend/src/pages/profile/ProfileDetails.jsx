...
//         // Update the profile data in your component state here
//       } else {
...
//             <label htmlFor="username" className="block text-brown font-bold mb-2">Username</label>
//             <input
//               name="username"
//               id="username"
//               type="text"
//               className="block w-full py-2 px-4 bg-transparent border-4 border-green text-green rounded-lg focus:outline-none focus:border-mustard"
//               value={username}
...
//                 id="newPassword"
//                 type="password"
//                 className="block w-full py-2 px-4 bg-transparent border-4 border-green text-green rounded-lg focus:outline-none focus:border-mustard mt-3"
